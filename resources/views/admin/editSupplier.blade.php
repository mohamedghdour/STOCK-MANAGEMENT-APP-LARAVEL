    ...
    <section class="content-header">
        ...
        <form method="POST" action="{{route('supplier.update',$supplier->id)}}" class="mt-5" >
            ...
            <div class="form-group">
              ...
              <input value="{{$supplier->name}}" type="text" name="name" class="form-control" id="nomproduit">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Adresse</label>
              <input value="{{$supplier->adress}}" type="text" name="adress" class="form-control" id="adress">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Numero de telephone</label>
              <input value="{{$supplier->phone_number}}" type="text" name="phone_number" class="form-control" id="phone_number">
            </div>
